    ...
    <div className="min-h-full">
      ...
      <section className="border-b border-gray-100 px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-widest text-gray-400">{scenario.eyebrow}</p>
          <h1 className="mt-3 text-4xl font-bold leading-tight tracking-tight text-gray-900">{scenario.title}</h1>
          <p className="mt-4 text-lg leading-relaxed text-gray-500">{scenario.intro}</p>
        </div>
      </section>
      ...
      <section className="bg-gray-50 px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mb-10 text-gray-500">One best-in-class option per category. No filler.</p>

          {essential.length > 0 && (
            <div className="mb-12">
              <h3 className="mb-4 text-sm font-bold uppercase tracking-widest text-gray-400">Essential</h3>
          ...
          {recommended.length > 0 && (
            <div className="mb-12">
              <h3 className="mb-4 text-sm font-bold uppercase tracking-widest text-gray-400">Recommended</h3>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {premium.length > 0 && (
            <div>
              <h3 className="mb-4 text-sm font-bold uppercase tracking-widest text-gray-400">Premium</h3>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      {/* Kit builder CTA */}
      <section id="kit-builder" className="px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-gray-900">Build your {scenario.title.toLowerCase()} kit</h2>
            <p className="mt-3 text-gray-500">Personalised to your household size, prep level, and budget.</p>
          </div>
